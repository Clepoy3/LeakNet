...
//-----------------------------------------------------------------------------
//void CMainFrame::OnActivateApp(BOOL bActive, HTASK hTask) // VXP: Conv
#if _MSC_VER < 1300
...
//-----------------------------------------------------------------------------
//void CMainFrame::OnApplicator(UINT nID) // VXP: Conv
...
//-----------------------------------------------------------------------------
//void CMainFrame::OnHelpOpenURL(int nID) // VXP: Conv
...
{
//	fstream file("winstate.wc", ios::in | ios::nocreate | ios::binary); // VXP: Conv
	std::fstream file("winstate.wc", std::ios::in | std::ios::binary);
...
//-----------------------------------------------------------------------------
//void CMainFrame::OnUnits(int nID) // VXP: Conv
