...
CHLMasterDlg::CHLMasterDlg( int nMasterPort, 
					...
					CWnd* pParent)
*/
CHLMasterDlg::CHLMasterDlg( int nMasterPort, bool bGenerateLogs, char *strLocalIPAddress )
{
...
//	m_hEditMOTD.SetWindowText("No MOTD"); // VXP: TODO
