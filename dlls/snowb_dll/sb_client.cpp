...
//
// Purpose:		Snowball client/server game specific stuff.
//
// $NoKeywords: $
//=============================================================================
...
{
	// Allocate a CSBPlayer for pev, and call spawn
	CSBPlayer *pPlayer = CSBPlayer::CreatePlayer( "player", pEdict );
...
CGameRules *InstallGameRules( void )
{
	...
	// Teamplay
	CSBGameRules *pEnt = dynamic_cast< CSBGameRules* >( CreateEntityByName( "sb_gamerules" ) );
	if ( !pEnt )
